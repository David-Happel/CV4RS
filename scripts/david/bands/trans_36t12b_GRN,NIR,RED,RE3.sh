...
echo "Executing..."
python3 main.py --epochs 50 --batch_size 12 --timepoints 36 --model trans --trans_layers 1 --name trans_36t12b1lGRN,NIR,RED,RE3 --no_process_data --bands GRN,NIR,RED,RE3